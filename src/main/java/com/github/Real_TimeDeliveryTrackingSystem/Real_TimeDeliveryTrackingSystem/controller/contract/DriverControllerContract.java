...
public interface DriverControllerContract {
    ...
    ResponseEntity<AddressVO> addAddressToDriver(@RequestBody AddressVO addressVO);
    ...
    ResponseEntity<AddressVO> updateAddressOfADriver(@RequestBody AddressVO addressVO);
    ...
    ResponseEntity<AddressVO> findAddressOfADriverByItsId(@PathVariable("id")String AddressId);
    ...
    ResponseEntity<Page<AddressVO>> findAllAddressesOfADriver(Pageable pageable);
    ...
    ResponseEntity<Void> deleteAddressOfADriver(@PathVariable("id") String addressId);
